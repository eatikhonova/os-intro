...
![Вызываем vi и создаем файл hello.sh](image/1.png){ #fig:001 }
 
4.	Нажимаем клавишу «i» и вводим текст, указанный в лабораторной работе 

![Нажимаем клавишу «i» и вводим текст](image/2.png){ #fig:002 }
...
![Делаем файл исполняемым](image/3.png){ #fig:003 }
...
![Вызовем vi для редактирования файла](image/4.png){ #fig:004 }
...
![Введем команду отмены изменений «u»](image/5.png){ #fig:005 }
